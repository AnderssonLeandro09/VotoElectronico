...
public class PersonaDao extends AdaptadorDao<Persona> {
    ...
    public int contarVotosA() throws VacioException, PosicionException {
        ListaEnlazada<Persona> lista = listar();
        int contador = 0;

        for (int i = 0; i < lista.size(); i++) {
            Persona persona = lista.get(i);
            if (persona.getEleccionVoto().equalsIgnoreCase("VotoA")) {
                contador++;
            }
        }
    ...
    public int contarVotosB() throws VacioException, PosicionException {
        ListaEnlazada<Persona> lista = listar();
        int contador = 0;

        for (int i = 0; i < lista.size(); i++) {
            Persona persona = lista.get(i);
            if (persona.getEleccionVoto().equalsIgnoreCase("VotoB")) {
                contador++;
            }
        }
    ...
    public int contarVotosBlancos() throws VacioException, PosicionException {
        ListaEnlazada<Persona> lista = listar();
        int contador = 0;

        for (int i = 0; i < lista.size(); i++) {
            Persona persona = lista.get(i);
            if (persona.getEleccionVoto().equalsIgnoreCase("VotoBlanco")) {
                contador++;
            }
        }
    ...
    public int contarVotosNulos() throws VacioException, PosicionException {
        ListaEnlazada<Persona> lista = listar();
        int contador = 0;

        for (int i = 0; i < lista.size(); i++) {
            Persona persona = lista.get(i);
            if (persona.getEleccionVoto().equalsIgnoreCase("VotoNulo")) {
                contador++;
            }
        }
    ...
    public int contarTotalVotos() throws VacioException, PosicionException {
        ListaEnlazada<Persona> lista = listar();
        int contador = 0;

        for (int i = 0; i < lista.size(); i++) {
            Persona persona = lista.get(i);
            if (!persona.getEleccionVoto().isEmpty()) {
                contador++;
            }
        }
